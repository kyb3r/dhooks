...
<br>
<div align="center">
    This <strong>simple</strong> library enables you to easily interact with discord webhooks, allowing you to easily format discord messages as well as retrieve webook information, modify and delete webhooks. Normal as well as asynchronous requests are supported within the library through an easy to use API.
</div>
